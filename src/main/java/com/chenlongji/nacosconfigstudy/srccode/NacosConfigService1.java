...
public class NacosConfigService1 implements ConfigService {

    private static final Logger LOGGER = LogUtils.logger(NacosConfigService1.class);
    ...
    public NacosConfigService1(Properties properties) throws NacosException {
